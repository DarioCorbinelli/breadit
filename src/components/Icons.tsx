...
import { ChevronLeft, Home, Laptop, Loader2, LogOut, LucideProps, Moon, Sun, User, X, Image, Link2, MessageSquare } from 'lucide-react'
import { forwardRef } from 'react'

export const Icons = {
  logo: forwardRef<SVGSVGElement, LucideProps>((props: LucideProps, ref) => (
    <svg ref={ref} {...props} viewBox='0 0 497 497'>
      <g>
  ...
  google: forwardRef<SVGSVGElement, LucideProps>(({ className, ...props }: LucideProps, ref) => (
    <svg ref={ref} className={cn('h-4 w-4', className)} {...props} viewBox='0 0 24 24'>
